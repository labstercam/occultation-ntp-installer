...
Intended to enable timing accuracy of low milli-seconds for WIndows PCs by using a curated list of National Standards servers and high quality pool servers.
